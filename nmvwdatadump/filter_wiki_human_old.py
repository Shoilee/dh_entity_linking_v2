"""
This file creates concatenated file with wikidata instances,
but to find out which instances are "E21_person" we need to make fedarated query from wikidata
An old workaround from August 2022
"""
